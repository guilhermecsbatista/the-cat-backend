...
public class BreedPostgresGetProviderImplTest {
  ...
  @Before
  public void setUp() {
    this.breedPostgresGetProvider =
        new BreedPostgresGetProviderImpl(this.breedRepository, this.breedTemperamentRepository);
  }

  @Test
  public void getAllTest() {
    when(this.breedRepository.findAll())
        .thenReturn(Collections.singletonList(BreedTableSeed.getBreedTable()));
    this.breedPostgresGetProvider.getAll();
  }

  @Test
  public void getByIdTest() {
    when(this.breedRepository.findById(any()))
        .thenReturn(Optional.of(BreedTableSeed.getBreedTable()));
  ...
  public void getByTemperamentIdTest() {
    when(this.breedTemperamentRepository.findByTemperamentId(any()))
        .thenReturn(
            Collections.singletonList(BreedTableSeed.getBreedTable().getTemperaments().get(0)));
  ...
  public void getByIntegrationIdTest() {
    when(this.breedRepository.findByIntegrationId(any()))
        .thenReturn(Optional.of(BreedTableSeed.getBreedTable()));
