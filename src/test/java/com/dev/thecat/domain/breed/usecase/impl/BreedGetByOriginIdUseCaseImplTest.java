...
public class BreedGetByOriginIdUseCaseImplTest {
    ...
    @Before
    public void setUp() {
        this.breedGetByOriginIdUseCase = new BreedGetByOriginIdUseCaseImpl(this.breedGetByOriginIdProvider);
    }

    @Test
    public void executeTest() {
        when(this.breedGetByOriginIdProvider.getByOriginId(any())).thenReturn(Collections.singletonList(BreedEntitySeeder.getBreedEntity()));
